...
<div id="container" class="container j-container">
  ...
  <?php } ?>
  <?php if ($warning) { ?>
  <div class="warning"><i class="fa fa-exclamation-triangle"></i> <?php echo $warning; ?></div>
  <?php } ?>
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="panel panel-default col-sm-9" style="width: 75%; display: inline-block;">
        ...
        <div class="thread">
          <div class="panel-heading col-sm-12 thread-created-info">
            <span class="info">
      ...
      success: function (json) {
        ...
        if (json['threads']) {
          ...
          for (var i = 0; i < jsonThreads.length; i++) {
            ...
            threads += '  <div class="panel-heading col-sm-12 thread-created-info">';
