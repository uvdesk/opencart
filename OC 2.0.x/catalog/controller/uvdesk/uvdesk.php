...
class ControllerUvdeskUvdesk extends Controller {
	...
	public function index() {
		...
		if (!$this->customer->getId() || !$this->config->get('uvdesk_status')) {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/uvdesk/uvdesk_list.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/uvdesk/uvdesk_list.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/uvdesk/uvdesk_list.tpl', $data));
		}
	}
	...
	public function create() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/uvdesk/uvdesk_form.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/uvdesk/uvdesk_form.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/uvdesk/uvdesk_form.tpl', $data));
		}
	}
	...
	public function view() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/uvdesk/uvdesk.tpl')) {
			$this->response->setOutput($this->load->view($this->config->get('config_template') . '/template/uvdesk/uvdesk.tpl', $data));
		} else {
			$this->response->setOutput($this->load->view('default/template/uvdesk/uvdesk.tpl', $data));
		}
	}
