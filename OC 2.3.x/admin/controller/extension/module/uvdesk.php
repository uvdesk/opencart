...
class ControllerExtensionModuleUvdesk extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/module/uvdesk', 'token=' . $this->session->data['token'], true)
		);

		$data['action'] = $this->url->link('extension/module/uvdesk', 'token=' . $this->session->data['token'], true);
